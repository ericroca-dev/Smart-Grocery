...
class AddListTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cellIdentifier = "AddListTableViewCell"
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? AddListTableViewCell else {
            fatalError("The dequeued cell is not an instance of AddListTableViewCell.")
        }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let nameCell = tableView.cellForRow(at: nameIndexPath) as! AddListTableViewCell
